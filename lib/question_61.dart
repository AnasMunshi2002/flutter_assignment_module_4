...
class _MenuScreenState extends State<MenuScreen> {
  List<MenuDishes> _menuList = [
    MenuDishes(
        ...
        price: 13.50,
        noReview: 12,
        image: AssetImage('assets/images/poached-egg.jpeg')),
    MenuDishes(
        title: 'Avocado Salad Gluten Free',
        rating: 4,
        price: 19.28,
        noReview: 29,
        image: AssetImage('assets/images/avocado-salad.jpeg')),
    MenuDishes(
    ...
    MenuDishes(
        ...
        price: 13.50,
        noReview: 12,
        image: AssetImage('assets/images/veg-soup.jpeg')),
    MenuDishes(
        title: 'Chicken Burger',
        rating: 4.5,
        price: 13.50,
        noReview: 12,
        image: AssetImage('assets/images/chicken-burger.jpeg')),
    MenuDishes(
        title: 'Ice Cream',
        rating: 3,
        price: 13.50,
    ...
    MenuDishes(
        ...
        price: 13.50,
        noReview: 12,
        image: AssetImage('assets/images/chicken-manchurian.jpeg')),
  ];
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Email : anasmunshi2002@gmail.com",
                      style:
